...
def objetivo_area(codigo_ls: str) -> str:
    """
    Devuelve un objetivo general de auditorÃ­a por Ã¡rea.
    """
    objetivos = {
        "14": "Verificar la existencia, valuaciÃ³n, presentaciÃ³n y revelaciÃ³n adecuada de las inversiones no corrientes.",
        "140": "Verificar la existencia, integridad y razonabilidad del efectivo y equivalentes de efectivo.",
        "130.1": "Verificar la existencia, recuperabilidad y presentaciÃ³n de las cuentas por cobrar corrientes.",
        "130.2": "Verificar la razonabilidad y clasificaciÃ³n de otras cuentas por cobrar.",
        "35": "Verificar la recuperabilidad y presentaciÃ³n de cuentas por cobrar no corrientes.",
        "110": "Verificar existencia, valuaciÃ³n y presentaciÃ³n de inventarios.",
        ...
        "425": "Verificar integridad, clasificaciÃ³n y presentaciÃ³n de cuentas por pagar.",
        "425.1": "Verificar integridad, clasificaciÃ³n y presentaciÃ³n de cuentas por pagar no corrientes.",
        "425.2": "Verificar integridad, clasificaciÃ³n y presentaciÃ³n de otras cuentas por pagar.",
        "200": "Verificar la composiciÃ³n, movimientos y presentaciÃ³n adecuada del patrimonio.",
        "1500": "Verificar ocurrencia, integridad, corte y presentaciÃ³n adecuada de los ingresos.",
        "1501": "Verificar ocurrencia, integridad y presentaciÃ³n de ingresos financieros u otros ingresos.",
        "1600": "Verificar razonabilidad, clasificaciÃ³n y presentaciÃ³n de gastos administrativos.",
        "1601": "Verificar razonabilidad, clasificaciÃ³n y presentaciÃ³n de gastos financieros.",
        "1700": "Verificar razonabilidad, clasificaciÃ³n y presentaciÃ³n de gastos de ventas u otros ingresos segÃºn corresponda.",
        "1701": "Verificar razonabilidad y soporte de gastos de logÃ­stica.",
        "1800": "Verificar razonabilidad, clasificaciÃ³n y presentaciÃ³n de otros gastos.",
        "1900": "Verificar razonabilidad y soporte del gasto por impuesto a la renta.",
    }

    return objetivos.get(
        codigo_ls,
        f"Verificar la razonabilidad, clasificaciÃ³n, presentaciÃ³n y revelaciÃ³n del Ã¡rea L/S {codigo_ls}."
    )
...
def imprimir_programa_auditoria(nombre_cliente: str, codigo_ls: str) -> None:
    ...
    print("\n===================================================================")
    print(f"PROGRAMA DE AUDITORÃA | {obtener_nombre_area_ls(codigo_ls)} | L/S {codigo_ls}")
    print("===================================================================\n")
    ...
    if top.empty:
        print("- No se identificaron cuentas significativas por variaciÃ³n.")
    else:
        for _, row in top.iterrows():
            print(
                f"- {row['numero_cuenta']} | {row['nombre_cuenta']} | "
                f"Saldo actual: {row['saldo_actual']:,.2f} | "
                f"VariaciÃ³n: {row['variacion_absoluta']:,.2f}"
            )
    print()
...
if __name__ == "__main__":
    try:
        ...
        print(f"\nError generando programa de auditorÃ­a: {e}")
