...
def detectar_riesgos_area(area_df: pd.DataFrame, codigo_ls: str, perfil: dict):
    ...
    nombres_cuentas = " ".join(area_df["nombre_cuenta"].fillna("").astype(str).str.upper().tolist())
            ...
            riesgos.append(
                {
                    ...
                    "descripcion": f"La variacion acumulada ({abs_variacion_total:,.2f}) representa el {riesgo_relativo:.1%} "
        ...
        riesgos.append(
            {
                ...
                "descripcion": f"Se detectaron {cuentas_relevantes} cuentas relevantes (umbral alto: >= {cuentas_thresh_alto}). "
        ...
        riesgos.append(
            {
                ...
                "descripcion": f"Se detectaron {cuentas_relevantes} cuentas relevantes (umbral medio: >= {cuentas_thresh_medio}). "
        ...
        riesgos.append(
            {
                ...
                "descripcion": f"El area contiene {cuentas_sin_base} cuentas sin base comparativa. "
        ...
        riesgos.append(
            {
                ...
                "descripcion": "La entidad es una holding con subsidiarias y uso de VPP. "
                "Debe evaluarse valuacion, soporte y calculo del valor patrimonial proporcional.",
            }
        )

    if contexto.get("tiene_partes_relacionadas", False) and codigo_ls in [
        "14",
        "425",
        "425.1",
        "425.2",
        ...
        riesgos.append(
            {
                ...
                "descripcion": "El cliente presenta partes relacionadas. Deben evaluarse "
        ...
        riesgos.append(
            {
                ...
                "descripcion": "Se identifican cuentas asociadas al metodo de participacion patrimonial (VPP). "
        ...
        riesgos.append(
            {
                ...
                "descripcion": f"El perfil del cliente indica un riesgo global {riesgo_global.get('nivel', 'no especificado')}. "
